      ...
      <div class="container-xxl">
        <div class="row align-items-start g-4">
          ...
          <div class="col-12 col-lg-9">
            <!-- ===== CATEGORY CARDS (ĐÃ SỬA LINK) ===== -->
<div class="row g-4 browse-grid">

  <div class="col-6 col-md-4 col-lg">
    <a href="${cxt}/products?cat=1" class="browse-card text-decoration-none">
  ...
  <div class="col-6 col-md-4 col-lg">
    <a href="${cxt}/products?cat=2" class="browse-card text-decoration-none">
      <div class="browse-thumb">
  ...
  <div class="col-6 col-md-4 col-lg">
    <a href="${cxt}/products?cat=3" class="browse-card text-decoration-none">
      <div class="browse-thumb">
  ...
  <div class="col-6 col-md-4 col-lg">
    <a href="${cxt}/products?cat=4" class="browse-card text-decoration-none">
      <div class="browse-thumb">
  ...
  <div class="col-6 col-md-4 col-lg">
    <a href="${cxt}/products?cat=5" class="browse-card text-decoration-none">
      <div class="browse-thumb">
...
<!-- ===== END CATEGORY CARDS ===== -->
    ...
    <%-- ===== TOP SELLER (theo Purchased DESC) ===== --%>
